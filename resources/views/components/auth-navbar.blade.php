                    ...
                    <ul class="navbar-nav header-right">
                        <li class="nav-item">
                            <select class="selectpicker form-select i18n-select" id="langSwitcher">
                                <option value="en_GB" title="English" data-content="<img \='{{ '/assets/dashboardAssets/images/flags/gb-eng.svg' }}' alt=''> English">English</option>
                                <option value="pt_BR" title="Portuguese" data-content="<img src='{{ '/assets/dashboardAssets/images/flags/pt.svg' }}' alt=''> Português">Português</option>
                                <option value="fr_FR" title="French" data-content="<img src='{{ '/assets/dashboardAssets/images/flags/fr.svg' }}' alt=''> Français">Français</option>
                                <option value="de_DE" title="German" data-content="<img src='{{ '/assets/dashboardAssets/images/flags/de.svg' }}' alt=''> Deutsch">Deutsch</option>
                                <option value="it_IT" title="Italian" data-content="<img src='{{ '/assets/dashboardAssets/images/flags/it.svg' }}' alt=''> Italiano">Italiano</option>
                                <option value="jp_JP" title="Japanese" data-content="<img src='{{ '/assets/dashboardAssets/images/flags/jp.svg' }}' alt=''> 日本語">日本語</option>
                                <option value="es_ES" title="Spanish" data-content="<img src='{{ '/assets/dashboardAssets/images/flags/es.svg' }}' alt=''> Español">Español</option>
                                <option value="ar_TN" title="Arabic" data-content="<img src='{{ '/assets/dashboardAssets/images/flags/arab.svg' }}' alt=''> العربية">العربية</option>
                                <option value="tr_TR" title="Turkish" data-content="<img src='{{ '/assets/dashboardAssets/images/flags/tr.svg' }}' alt=''> Türkçe">Türkçe</option>
                            </select>
                        </li>
                                    ...
                                    <div class="dz-scroll p-2" style="height: 380px;">
                                        <div class="d-flex align-items-center p-2 bg-action-light rounded">
                                            <div class="d-inline-block">
                                                <img src="{{ "/assets/dashboardAssets/images/avatar/small/avatar1.webp" }}" alt="" class="rounded-circle avatar avatar-sm">
                                            </div>
                                        ...
                                        <div class="d-flex align-items-center p-2 bg-action-light rounded">
                                            <div class="d-inline-block">
                                                <img src="{{ "/assets/dashboardAssets/images/avatar/small/avatar2.webp" }}" alt="" class="rounded-circle avatar avatar-sm">
                                            </div>
                                            <div class="clearfix ms-2">
                                                <h6 class="fs-13 mb-0 fw-semibold">Resport created successfully</h6>
                                                <small>29 July 2020 - 02:26 PM</small>
                                        ...
                                        <div class="d-flex align-items-center p-2 bg-action-light rounded">
                                            <div class="d-inline-block">
                                                <img src="{{ "/assets/dashboardAssets/images/avatar/small/avatar3.webp" }}" alt="" class="rounded-circle avatar avatar-sm">
                                            </div>
                                            <div class="clearfix ms-2">
                                                <h6 class="fs-13 mb-0 fw-semibold">Dr sultads Send you Photo</h6>
                                                <small>29 July 2020 - 02:26 PM</small>
                                        ...
                                        <div class="d-flex align-items-center p-2 bg-action-light rounded">
                                            <div class="d-inline-block">
                                                <img src="{{ "/assets/dashboardAssets/images/avatar/small/avatar4.webp" }}" alt="" class="rounded-circle avatar avatar-sm">
                                            </div>
                                            <div class="clearfix ms-2">
                                                <h6 class="fs-13 mb-0 fw-semibold">Resport created successfully</h6>
                                                <small>29 July 2020 - 02:26 PM</small>
                            ...
                            <a class="nav-link" href="javascript:void(0);" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                <div class="profile-head">
                                    <div class="profile-media">
                                        <img src="{{ "/assets/dashboardAssets/images/tab/1.jpg" }}" alt="">
                                    </div>
                                    <div class="header-info">
                                        <h6 class="author-name">Thomas Fleming</h6>
                                        <small><span class="__cf_email__" data-cfemail="92fbfcf4fdd2f5fff3fbfebcf1fdff">[email&#160;protected]</span></small>
                                    </div>
                                </div>
                            </a>
                            <ul class="dropdown-menu dropdown-menu-end">
                                <li>
                                    <div class="py-2 d-flex px-3">
                                        <img src="{{ "assets/dashboardAssets/images/tab/1.jpg" }}" class="avatar avatar-sm rounded-circle" alt="">
                                        <div class="ms-2">
