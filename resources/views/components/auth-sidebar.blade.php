<div class="deznav">
    <div class="deznav-scroll">
        <ul class="metismenu" id="menu">
            <li class="menu-title" data-i18n="CRM">CRM</li>
            <li>
...
{{--                </ul>--}}
            ...
            <li>
                <a href="finance.html" aria-expanded="false">
                    ...
                    <span class="nav-text" data-i18n="Deals">Leads</span>
                </a>
            </li>
            <li>
                <a class="has-arrow" href="javascript:void(0);" aria-expanded="false">
                    ...
                    <span class="nav-text" data-i18n="Leads">Leads</span>
                </a>
{{--                <ul aria-expanded="false">--}}
...
{{--                </ul>--}}
            ...
            <li>
                <a href="performance.html" aria-expanded="false">
                    ...
                    <span class="nav-text" data-i18n="Notes">Notes</span>
                </a>
            </li>
        </ul>
    </div>
    <div class="deznav-footer">
        <a href="{{ route('login') }}" target="_blank" class="btn btn-docs btn-success w-100">
            <span>Logout</span>
