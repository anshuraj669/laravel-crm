...
{{--                                        <path d="M16.9026 6.85114L12.4593 10.4642C11.6198 11.1302 10.4387 11.1302 9.59922 10.4642L5.11844 6.85114" stroke="var(--bs-body-color)" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>--}}
{{--                                        <path fill-rule="evenodd" clip-rule="evenodd" d="M15.9089 19C18.9502 19.0084 21 16.5095 21 13.4384V6.57001C21 3.49883 18.9502 1 15.9089 1H6.09114C3.04979 1 1 3.49883 1 6.57001V13.4384C1 16.5095 3.04979 19.0084 6.09114 19H15.9089Z" stroke="var(--bs-body-color)" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>--}}
{{--                                    </svg>--}}
{{--                                </a>--}}
{{--                            </li>--}}
...
{{--                                            <small><span class="__cf_email__" data-cfemail="7d14131b123d1a101c1411531e1210">[email&#160;protected]</span></small>--}}
{{--                                        </div>--}}
{{--                                    </div>--}}
{{--                                </a>--}}
{{--                                <ul class="dropdown-menu dropdown-menu-end">--}}
...
{{--                            <li><a href="construction/index.html" data-i18n="Construction" onclick="deleteAllCookie()">Construction</a></li>--}}
{{--                        </ul>--}}
{{--                    </li>--}}
{{--                    <li>--}}
...
{{--                            <li>--}}
{{--                                <a class="has-arrow" href="javascript:void(0);" aria-expanded="false" data-i18n="Users Manager">Users Manager</a>--}}
{{--                                <ul aria-expanded="false">--}}
...
{{--                            </li>--}}
{{--                            <li>--}}
{{--                                <a class="has-arrow" href="javascript:void(0);" aria-expanded="false" data-i18n="Customer Manager">Customer Manager</a>--}}
{{--                                <ul aria-expanded="false">--}}
...
{{--                            <li>--}}
{{--                                <a class="has-arrow" href="javascript:void(0);" aria-expanded="false" data-i18n="Email">Email</a>--}}
{{--                                <ul aria-expanded="false">--}}
...
{{--                            <li>--}}
{{--                                <a class="has-arrow" href="javascript:void(0);" aria-expanded="false" data-i18n="Shop">Shop</a>--}}
{{--                                <ul aria-expanded="false">--}}
...
{{--                <a href="https://coreui.w3itexperts.com/?theme=W3CRM" target="_blank" class="btn btn-docs btn-success w-100">--}}
                            ...
                            <div class="card-header py-3 d-sm-flex d-block align-items-center">
                                ...
                                @can('user.create')
                                    <div class="clearfix">
                                        ...
                                        <a href='{{ route('user.create') }}' class="btn btn-primary btn-sm m-1" data-bs-toggle="offcanvas"  role="button" aria-controls="offcanvasExample">+ Add Employee</a>
                            ...
                            <div class="card-body table-card-body px-0 pt-0 pb-2">
                                <div class="table-responsive">
                                    <table id="employeesTable" class="table">
                                        ...
                                        <tr>
                                            <th class="mw-120">Employee ID</th>
                                            <th class="mw-150">Employee Name</th>
                                            <th class="mw-150">Email Address</th>
                                            <th class="mw-150">Contact Number</th>
                                            <th class="mw-100">Role</th>
                                            <th class="mw-150">Department</th>
                                            <th class="mw-150">Designation</th>
                                            <th class="mw-150">Joining Date</th>
                                        </tr>
                                        </thead>
                                        <tbody>
...
{{--                <h2 class="modal-title fs-5" id="#gridSystemModal1">Add New Task</h2>--}}
{{--                <button type="button" class="btn btn-square btn-danger light btn-sm ms-auto" data-bs-dismiss="offcanvas" aria-label="Close">--}}
...
{{--                        <input type="text" class="form-control bs-datepicker" id="exampleFormControlInputthree">--}}
{{--                    </div>--}}
{{--                    <div class="col-xl-6 mb-3">--}}
{{--                        <label for="exampleFormControlInputfour" class="form-label">End Date<span class="text-danger">*</span></label>--}}
{{--                        <input type="text" class="form-control bs-datepicker" id="exampleFormControlInputfour">--}}
{{--                    </div>--}}
{{--                    <div class="col-xl-6 mb-3">--}}
{{--                        <label class="form-label">Estimated Hour<span class="text-danger">*</span></label>--}}
{{--                        <input type="text" class="form-control bs-datepicker" value="09:30">--}}
{{--                    </div>--}}
{{--                    <div class="col-xl-6 mb-3">--}}
...
{{--                            <option value="Larry Ellison">Larry Ellison</option>--}}
{{--                        </select>--}}
{{--                    </div>--}}
{{--                    <div class="col-xl-6 mb-3">--}}
{{--                        <label class="form-label">Responsible Person<span class="text-danger">*</span></label>--}}
{{--                        <input name='tagify' class="form-control basic-tagify" value='James, Harry'>--}}
{{--                    </div>--}}
...
{{--        <!-- Start - Add Contacts Modal -->--}}
{{--        <div class="offcanvas offcanvas-end custom-offcanvas" tabindex="-1" id="offcanvasExample">--}}
{{--            <div class="offcanvas-header pb-0">--}}
{{--                <h2 class="modal-title fs-5" id="#gridSystemModal">Add Employee</h2>--}}
{{--                <button type="button" class="btn btn-square btn-danger light btn-sm ms-auto" data-bs-dismiss="offcanvas" aria-label="Close">--}}
{{--                    <i class="fa-solid fa-xmark"></i>--}}
{{--                </button>--}}
{{--            </div>--}}
...
{{--                                <option value="Web Doveloper">Web Doveloper</option>--}}
{{--                            </select>--}}
{{--                        </div>--}}
{{--                        <div class="col-xl-6 mb-3">--}}
...
{{--                            <input type="number" class="form-control type-number" id="exampleFormControlInput88" placeholder="">--}}
{{--                        </div>--}}
{{--                        <div class="col-xl-6 mb-3">--}}
...
{{--                            <input type="text" class="form-control bs-datepicker" id="exampleFormControlInput99">--}}
{{--                        </div>--}}
{{--                        <div class="col-xl-6 mb-3">--}}
{{--                            <label for="exampleFormControlInput8" class="form-label">Date of Birth<span class="text-danger">*</span></label>--}}
{{--                            <input type="text" class="form-control bs-datepicker" id="exampleFormControlInput8">--}}
{{--                        </div>--}}
{{--                        <div class="col-xl-6 mb-3">--}}
...
{{--            </div>--}}
{{--        </div>--}}
{{--        <!-- End - Add Contacts Modal -->--}}

{{--        <!-- Start - Invite Customer Modal -->--}}
{{--        <div class="modal fade" id="exampleModal1" tabindex="-1" aria-labelledby="exampleModalLabel1" aria-hidden="true">--}}
{{--            <div class="modal-dialog modal-dialog-centered">--}}
{{--                <div class="modal-content">--}}
{{--                    <div class="modal-header">--}}
{{--                        <h2 class="modal-title fs-5" id="exampleModalLabel1">Invite Customer</h2>--}}
...
{{--                                <input class="form-control bs-datepicker" type="text">--}}
{{--                            </div>--}}
{{--                            <div class="col-xl-6 mb-3">--}}
...
{{--                                <input type="email" class="form-control text-center" placeholder=" + invite ">--}}
{{--                            </div>--}}
{{--                        </div>--}}
{{--                    </div>--}}
