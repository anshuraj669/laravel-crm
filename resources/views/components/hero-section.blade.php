            ...
            <div class="row align-items-center cs_gap_y_40">
                <div class="col-lg-5 order-lg-2">
                    <div class="cs_hero_thumbnail cs_radius_15 position-relative wow fadeInRight">
                        <img src="{{ asset('assets/img/hero_img_4.jpg') }}" alt="Hero Image">
                        <div class="cs_hero_shape_vector position-absolute">
                            <img src="{{ asset('assets/img/quarter-circle.svg') }}" alt="Vector Shape">
                        </div>
                        <div class="cs_volume_report cs_white_bg cs_radius_15 position-absolute">
                            <img src="{{ asset('assets/img/volume.jpg') }}" alt="Volume report chart">
                        </div>
                        <div class="cs_sells_report cs_white cs_radius_20 position-absolute">
                            <img src="{{ asset('assets/img/sells-report.jpg') }}" alt="Sells report chart">
                        </div>
                    </div>
                </div>
                <div class="col-lg-7 order-lg-1">
                  ...
                  CRM
                  <img src="{{ asset('assets/img/vector.svg') }}" alt="Vector line" class="cs_line_1 position-absolute">
                  <img src="{{ asset('assets/img/vector-2.svg') }}" alt="Vector line" class="cs_line_2 position-absolute">
                  </span>
                        </h1>
