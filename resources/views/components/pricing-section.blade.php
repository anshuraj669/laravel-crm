<section class="position-relative">
    ...
    <div class="container position-relative z-1">
        ...
        <ul class="cs_pricing_control cs_type_1 cs_center p-0 position-relative">
            <li class="active"><a href="monthly.html" aria-label="Pricing toggle button">Monthly</a><span class="cs_switch"></span></li>
            <li>
                <a href="yearly.html" aria-label="Pricing toggle button">Annually</a>
